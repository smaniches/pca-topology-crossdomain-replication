...
Four cohorts, spanning four tissue/tumor types and three omics modalities, were analyzed (five cohort/layer analyses in total, since TCGA-LUAD contributes two omics layers --- RNA-seq and DNA methylation):
