...
| imputation_ablation_summary.csv | 0.7 KB |
| imputation_overlap_table.csv | 0.2 KB |
| interaction_check_table.csv | 0.6 KB |
...
| table1_within_class_decomposition.csv | 0.4 KB |
| table1_within_class_decomposition_CPTAC_CCRCC.csv | 0.7 KB |
| table1_within_class_decomposition_GSE146889.csv | 0.4 KB |
| table1_within_class_decomposition_TCGA_LUAD.csv | 0.4 KB |
| table2_within_stratum_control.csv | 0.5 KB |
| table2_within_stratum_control_CPTAC_CCRCC.csv | 0.5 KB |
| table2_within_stratum_control_GSE146889.csv | 0.9 KB |
| table2_within_stratum_control_TCGA_LUAD.csv | 0.6 KB |
| table3_residualization_control.csv | 0.2 KB |
| table3_residualization_control_CPTAC_CCRCC.csv | 0.4 KB |
| table3_residualization_control_GSE146889.csv | 0.5 KB |
| table3_residualization_control_TCGA_LUAD.csv | 0.5 KB |
| table4_block_bootstrap_ci.csv | 0.3 KB |
| table4_block_bootstrap_ci_CPTAC_CCRCC.csv | 0.2 KB |
| table4_block_bootstrap_ci_GSE146889.csv | 0.5 KB |
| table4_block_bootstrap_ci_TCGA_LUAD.csv | 0.3 KB |
| table5_confound_spectrum.csv | 0.2 KB |
| table5_confound_spectrum_CPTAC_CCRCC.csv | 0.3 KB |
...
| permutation_test_summary.csv | 0.9 KB |
...
| File | Size |
|---|---|
| bh_correction_family_table.csv | 0.7 KB |
| cptac_ccrcc_report.md | 12.8 KB |
| cptac_final_results_table.csv | 0.7 KB |
| cptac_h1_pca_delta_table.csv | 0.3 KB |
...
| File | Size |
|---|---|
| tcga_luad_confound_cv_auc.csv | 0.2 KB |
| tcga_luad_h1_pca_delta_summary.csv | 0.7 KB |
