...
- **What survives:** Both the tumor-only and normal-only subsets show real topological structure clearing their own null distributions by wide margins (z=25.0 and z=12.8 against Gaussian null). Residualization in the **raw HVG (2000-d) space** leaves the signal intact (z=14.5 Gaussian / z=12.1 permutation) despite CV AUC collapsing to 0.000. The block-bootstrap CI on the within-tumor signal-beyond-null excludes zero.
